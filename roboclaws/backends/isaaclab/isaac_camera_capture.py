...
from roboclaws.backends.isaaclab import isaac_capture_payloads
...
def _capture_payload(
    *,
    ...
    return isaac_capture_payloads.capture_payload(
        request=request,
        stage=stage,
        render_state=render_state,
        rendered=rendered,
        segmentation_payload=lambda: _segmentation_payload(
            request=request,
            hooks=hooks,
            stage=stage,
            rendered=rendered,
