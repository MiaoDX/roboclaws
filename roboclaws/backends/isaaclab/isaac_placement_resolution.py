"""Isaac Lab backend runtime support."""
...
from roboclaws.backends.isaaclab import isaac_placement_diagnostics
from roboclaws.backends.isaaclab.isaac_support_surface_geometry import (
...
PLACEMENT_DIAGNOSTIC_SCHEMA = isaac_placement_diagnostics.PLACEMENT_DIAGNOSTIC_SCHEMA
ISAAC_PLACEMENT_RESOLVER_SOURCE = "isaac_support_placement_resolver"

aabb_xy_overlaps = placement_geometry.aabb_xy_overlaps
candidate_has_direct_support = placement_geometry.candidate_has_direct_support
elevated_position_over_surface = placement_geometry.elevated_position_over_surface
surface_candidate_positions = placement_geometry.surface_candidate_positions
...
def isaac_placement_diagnostic(
    *,
    ...
    return isaac_placement_diagnostics.placement_diagnostic(
        state=state,
        object_id=object_id,
        receptacle_id=receptacle_id,
        relation=relation,
