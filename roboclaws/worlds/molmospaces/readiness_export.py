"""Export deterministic MolmoSpaces scene-sampler readiness artifacts."""
...
from roboclaws.worlds.molmospaces.sampling import eval_sampler_rows, sampler_manifest
...
def _write_requested_artifacts(
    *,
    ...
    if write_generated_eval:
        artifacts.update(write_generated_eval_artifacts(output_dir))
    return artifacts
...
def write_generated_eval_artifacts(output_dir: Path) -> dict[str, str | list[str]]:
