...
Run the long-horizon household open-task samples with:
...
navigation, observation, pick/place, open/close receptacle, and done. Stairs,
elevators, parcel unpacking, and drawer-specific interaction are follow-on
