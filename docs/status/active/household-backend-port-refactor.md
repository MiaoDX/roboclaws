...
- Current slice: repo-wide deterministic verification and final documentation alignment
...
- Next slice: repo-wide deterministic proof and final documentation alignment
- Next proof: `just agent::verify`, then `intuitive-doc` alignment against `README.md`,
